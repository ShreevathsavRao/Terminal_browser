"""Unix Terminal Widget - PTY-based implementation for macOS and Linux

This module provides full-featured terminal emulation using Unix PTY (pseudo-terminal)
for macOS and Linux platforms. It maintains all existing functionality from the original
pyte_terminal_widget implementation.
"""
...
class UnixTerminalWidget(BaseTerminalWidget):
    """Terminal widget with full PTY-based terminal emulation for Unix (macOS/Linux)
    
    This class inherits from BaseTerminalWidget and provides the complete
    Unix implementation using PTY, maintaining all existing features.
    """
    
    # Note: Signals are defined in BaseTerminalWidget
